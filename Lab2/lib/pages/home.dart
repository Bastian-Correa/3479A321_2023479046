    ...
    return [
      Row(
        ...
        children: [
          ...
          // Botón de paleta, usa el color del Theme global
          ElevatedButton(
            onPressed: _palette,
            style: ElevatedButton.styleFrom(
              shape: RoundedRectangleBorder(
          ...
          children: <Widget>[
            ...
            Expanded(
              child: SingleChildScrollView(
                ...
                child: Row(
                  children: [
                    Image.asset('assets/Pizza.png', height: 250, width: 300),
                    Image.asset('assets/Aji.png', height: 250, width: 300),
                    Image.asset('assets/Sandia.png', height: 250, width: 300),
                  ],
                ),
              ),
            ),
